...
/* APB1 */
#define TIMER2_BASE			(PERIPH_BASE_APB1 + 0x0400)
#define TIMER5_BASE			(PERIPH_BASE_APB1 + 0x1000)
#define TIMER13_BASE		(PERIPH_BASE_APB1 + 0x2000)
