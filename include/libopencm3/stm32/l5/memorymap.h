...
#define DFSDM1_BASE			(PERIPH_BASE_APB2 + 0x6000)
...
#define GTZC_MPCBB2_BASE	(PERIPH_BASE_AHB1 + 0x13000)
...
#define ADC_BASE			(PERIPH_BASE_AHB2 + 0x8000)
#define ADC_Common_BASE		(PERIPH_BASE_AHB2 + 0x8300)
...
#define OCTOSPI1_BASE		(PERIPH_BASE_AHB3 + 0x1000)

#define DBGMCU_BASE			(PPBI_BASE + 0x44000)

#define DESIG_UNIQUE_ID_BASE	(INFO_BASE + 0x590)
#define DESIG_FLASH_SIZE_BASE	(INFO_BASE + 0x5e0)

#define DESIG_PACKAGE			MMIO16((INFO_BASE + 0x500))
#define DESIG_UNIQUE_ID0		MMIO32(DESIG_UNIQUE_ID_BASE)
#define DESIG_UNIQUE_ID1		MMIO32(DESIG_UNIQUE_ID_BASE + 4)
#define DESIG_UNIQUE_ID2		MMIO32(DESIG_UNIQUE_ID_BASE + 0x14)

/* ST provided factory calibration values @ 3.0V */
#define ST_VREFINT_CAL			MMIO16((INFO_BASE + 0x5AA))
#define ST_TSENSE_CAL1_30C		MMIO16((INFO_BASE + 0x5A8))
#define ST_TSENSE_CAL2_110C		MMIO16((INFO_BASE + 0x5CA))
